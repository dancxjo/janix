...
## Supervisor Refinement & Diagnostic Tools

The system supervisor (`Sprout`) has been upgraded with a phased startup mechanism to ensure robust initialization of hardware, drivers, and core services. This release also introduces a suite of diagnostic and benchmarking tools to validate system performance and behavior.

### 🚀 Phased Supervisor Startup
...
*   **Root Batch Bench**: A benchmark for measuring the throughput of graph mutation batches (CreateNode + PutEdge) applied to the kernel graph.
