...
APPS := init init_debug clock window_demo compositor hello_world geographer debug_alloc debug_thread debug_input_logger debug_input_events
...
$(IMAGE_NAME).iso: limine/limine kernel user drivers icons assets
	...
	for app in clock window_demo compositor hello_world geographer debug_alloc debug_thread debug_input_logger debug_input_events; do \
