...
ENABLE_ROOTFS ?= 0
APPS := init hello heartbeat thread_dashboard clock_demo alarm_demo ps2_keyboard_driver ps2_mouse_driver input_logger_demo framebuffer_driver compositor window_demo
