...
pub const KIND_NET_FETCH_RESOURCE: ThingKind = 0x1A;
...
pub const PROP_NET_URL: PropKey = 0x12;
pub const PROP_NET_STATUS: PropKey = 0x13;
pub const PROP_NET_MIME: PropKey = 0x14;
pub const PROP_NET_FETCHED_AT: PropKey = 0x15;
pub const PROP_RESOURCE_XML_DOCUMENT: PropKey = 0x16;
pub const PROP_RESOURCE_XML_SANITIZED: PropKey = 0x17;
pub const PROP_XML_IMPORT_ERROR: PropKey = 0x18;
