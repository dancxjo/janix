...
/// Initialize SIMD (SSE/AVX) on x86_64.
///
/// # Safety
/// Must be called after CR0/CR4 are configured for SSE.
/// The _start function already sets CR0.EM=0, CR0.MP=1, CR4.OSFXSR=1, CR4.OSXMMEXCPT=1.
pub unsafe fn init_simd() {
    // SSE is already enabled by the _start assembly.
