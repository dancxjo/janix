...
| 1 | the graph should contain a Thing of kind "kind.Process" | ❌ | �� 📝  |
| 2 | that process should have a name "sprout" | ❌ | �� 📝  |
| 3 | the serial log should contain "sprout: online" | ❌ | �� 📝  |
...
### 3. that process should have a name "sprout" ❌

![Screenshot](steps/002_that_process_should_have_a_name__sprout_/screen.png)
...
### 4. the serial log should contain "sprout: online" ❌

![Screenshot](steps/003_the_serial_log_should_contain__sprout__online_/screen.png)
