...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | the process "logview" has capability "cap.map_memory" | ⏭️ | �� 📝  |
...
### 2. the process "logview" has capability "cap.map_memory" ❌

![Screenshot](steps/001_the_process__logview__has_capability__cap_map_memory_/screen.png)
