...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | the process "logview" has no capability "cap.read_input" | ⏭️ | �� 📝  |
...
### 2. the process "logview" has no capability "cap.read_input" ❌

![Screenshot](steps/001_the_process__logview__has_no_capability__cap_read_input_/screen.png)
