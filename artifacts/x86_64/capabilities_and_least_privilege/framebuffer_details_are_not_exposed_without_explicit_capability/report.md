...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | the process "bloom" has no capability "cap.framebuffer" | ⏭️ | �� 📝  |
...
### 2. the process "bloom" has no capability "cap.framebuffer" ❌

![Screenshot](steps/001_the_process__bloom__has_no_capability__cap_framebuffer_/screen.png)
