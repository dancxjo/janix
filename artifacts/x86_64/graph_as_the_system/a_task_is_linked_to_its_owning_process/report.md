...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | I query the graph for the Thing named "sprout" | ⏭️ | �� 📝  |
...
### 2. I query the graph for the Thing named "sprout" ❌

![Screenshot](steps/001_i_query_the_graph_for_the_thing_named__sprout_/screen.png)
