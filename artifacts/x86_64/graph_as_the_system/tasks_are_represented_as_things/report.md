...
| 1 | I query the graph for Things of kind "kind.Task" | ⏭️ | �� 📝  |
...
### 2. I query the graph for Things of kind "kind.Task" ❌

![Screenshot](steps/001_i_query_the_graph_for_things_of_kind__kind_task_/screen.png)
