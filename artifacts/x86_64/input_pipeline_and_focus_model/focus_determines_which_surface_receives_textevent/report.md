...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | there are two surfaces "win.left" and "win.right" | ⏭️ | �� 📝  |
...
### 2. there are two surfaces "win.left" and "win.right" ❌

![Screenshot](steps/001_there_are_two_surfaces__win_left__and__win_right_/screen.png)
