...
| :---: | --- | :---: | --- |
| 0 | sprout is online | ✅ | �� 📝  |
| 1 | the process "inputd" has capability "cap.read_input" | ⏭️ | �� 📝  |
...
### 2. the process "inputd" has capability "cap.read_input" ❌

![Screenshot](steps/001_the_process__inputd__has_capability__cap_read_input_/screen.png)
