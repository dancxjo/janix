...
| 2 | bloom should be able to draw | ⏭️ | �� 📝  |
...
### 2. I boot the system with display provider "limine_fb" ✅

![Screenshot](steps/001_i_boot_the_system_with_display_provider__limine_fb_/screen.png)
...
### 3. bloom should be able to draw ❌

![Screenshot](steps/002_bloom_should_be_able_to_draw/screen.png)
