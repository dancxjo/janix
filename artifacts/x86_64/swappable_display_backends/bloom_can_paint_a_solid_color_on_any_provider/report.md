# Scenario: Bloom can paint a solid color on any provider
...
| :---: | --- | :---: | --- |
| 0 | I boot the system with display provider "ramfb" | ✅ | �� 📝  |
| 1 | sprout is online | ✅ | �� 📝  |
| 2 | the process "bloom" has capability "cap.framebuffer" | ⏭️ | �� 📝  |

## Execution Details

### 1. I boot the system with display provider "ramfb" ✅

![Screenshot](steps/000_i_boot_the_system_with_display_provider__ramfb_/screen.png)
...
SYM:: module phys=7918d000 offset=ffff800000000000
...
### 3. the process "bloom" has capability "cap.framebuffer" ❌

![Screenshot](steps/002_the_process__bloom__has_capability__cap_framebuffer_/screen.png)
