...
impl XhciController {
    pub unsafe fn new(bar0: u64) -> Result<Self, i32> {
        ...
        let base = res.val0;
        log_info(&alloc::format!("xHCI: Mapped BAR0 {:#x} -> {:#x}", phys, base));
    ...
    pub fn init(&mut self) {
        ...
        unsafe {
            ...
            log_info("xHCI: Reset pending/complete (controller might need more setup for Run/Stop)");
        }
    }
