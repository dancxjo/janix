...
pub fn init<B: HardwareBridge>(k: &mut Kernel<B>, pci_devices: &[PciDeviceBody]) -> Option<(u64, u64)> {
...
pub fn set_mode(bridge: &impl HardwareBridge, width: u16, height: u16, bpp: u16) {
    ...
    write_reg(bridge, VBE_DISPI_INDEX_ENABLE, VBE_DISPI_ENABLED | VBE_DISPI_LFB_ENABLED);
}
