...
pub fn sys_driver_wait<B: FullMachineBridge>(
    kernel: &mut Kernel<B>,
    out_ptr: *mut u8,
    out_len: usize,
) -> SysRet {
...
pub fn sys_driver_publish<B: FullMachineBridge>(
    kernel: &mut Kernel<B>,
    ptr: *const u8,
    len: usize,
) -> SysRet {
...
pub fn sys_mmio_map<B: FullMachineBridge>(
    kernel: &mut Kernel<B>,
    phys_addr: u64,
    len: u64,
) -> SysRet {
...
pub fn sys_irq_register<B: FullMachineBridge>(_kernel: &mut Kernel<B>, _irq: usize) -> SysRet {
    // TODO: Register IRQ owner in interrupt router.
    // For now, standard PC interrupts are broadcast or we assume single driver.
    0
}

pub fn sys_port_io<B: FullMachineBridge>(
    kernel: &mut Kernel<B>,
    port: u16,
    val: u32,
    width: u8,
