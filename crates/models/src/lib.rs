...
use alloc::vec::Vec; // Ensure we have access to Vec for glue
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Thing)]
#[thing(kind = "kind.Relationship", schema = "schema.Relationship", version = 1)]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Thing)]
#[thing(kind = "kind.MonotonicClock", schema = "schema.MonotonicClock", version = 1)]
