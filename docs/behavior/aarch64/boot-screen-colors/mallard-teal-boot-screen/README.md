...
|---|------|--------|----------|-----------|
| 1 | Given the machine is started | ✅ | 292ms | <a href="./01/after.png"><img src="./01/after.png" width="150" /></a> [📜](./01/serial.log) [💾](./01/registers.txt) |
| 2 | When I wait for the system to boot | ❌ | 9823ms | - [📜](./02/serial.log) - |
