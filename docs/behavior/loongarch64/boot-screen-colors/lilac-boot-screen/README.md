...
> Last run: 2026-01-10 14:33:44

## Steps

| # | Step | Result | Duration | Artifacts |
|---|------|--------|----------|-----------|
| 1 | Given the machine is started | ✅ | 569ms | <a href="./01/after.png"><img src="./01/after.png" width="150" /></a> - [💾](./01/registers.txt) |
| 2 | When I wait for the system to boot | ✅ | 6582ms | <a href="./02/after.png"><img src="./02/after.png" width="150" /></a> [📜](./02/serial.log) [💾](./02/registers.txt) |
| 3 | Then the screen should be filled with "Lilac" | ✅ | 1681ms | <a href="./03/after.png"><img src="./03/after.png" width="150" /></a> - [💾](./03/registers.txt) |
...
[709157697] [INFO] Frame allocator initialized with 511556 free frames
[709407442] [INFO] Initializing global allocator...
[709972394] [INFO] Initializing tasking...
[710056127] [INFO]   Acquiring scheduler lock...
[710075619] [INFO]   Lock acquired, checking if initialized...
[710097977] [INFO]   Allocating scheduler...
