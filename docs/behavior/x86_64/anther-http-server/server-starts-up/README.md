...
|---|------|--------|----------|-----------|
| 1 | When I start the machine | ✅ | 4452ms | - [📜](./01/serial.log) - |
| 2 | Then I should see a message in the serial output that says "anther: Listening on port 80" | ✅ | 3641ms | - [📜](./02/serial.log) - |
