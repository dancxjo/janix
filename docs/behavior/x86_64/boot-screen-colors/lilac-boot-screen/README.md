...
|---|------|--------|----------|-----------|
| 1 | Given the machine is started | ✅ | 338ms | <a href="./01/after.png"><img src="./01/after.png" width="150" /></a> - [💾](./01/registers.txt) |
| 2 | When I wait for the system to boot | ✅ | 3679ms | - [📜](./02/serial.log) [💾](./02/registers.txt) |
