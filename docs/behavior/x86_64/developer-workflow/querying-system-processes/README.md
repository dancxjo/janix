...
|---|------|--------|----------|-----------|
| 1 | Given the machine is running | ✅ | 5065ms | - - - |
| 2 | And the anther server is ready | ✅ | 11167ms | - [📜](./02/serial.log) - |
| 3 | When I execute the GQL query "MATCH (n:proc.Task) RETURN n.name" | ✅ | 1613ms | - [📜](./03/serial.log) - |
