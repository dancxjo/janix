...
|---|------|--------|----------|-----------|
| 1 | Given the anther server is ready | ✅ | 30492ms | - [📜](./01/serial.log) - |
| 2 | When I execute the GQL query "CREATE (p:Project {name: \"Project Alpha\", status: \"Planning\"})" | ✅ | 831ms | - [📜](./02/serial.log) - |
| 3 | Then the response status should be 200 | ✅ | 14ms | - - - |
| 4 | And the response body should contain "success" | ✅ | 0ms | - - - |
| 5 | When I execute the GQL query "CREATE (t:Task {title: \"Draft Requirements\", assignedTo: \"Me\"})" | ✅ | 41150ms | - [📜](./05/serial.log) - |
| 6 | Then the response status should be 200 | ✅ | 0ms | - - - |
| 7 | When I execute the GQL query "MATCH (p:Project {name: \"Project Alpha\"}), (t:Task {title: \"Draft Requirements\"}) CREATE (p)-[:HAS_TASK]->(t)" | ✅ | 616ms | - [📜](./07/serial.log) - |
| 8 | Then the response status should be 200 | ✅ | 0ms | - - - |
| 9 | When I execute the GQL query "MATCH (p:Project {name: \"Project Alpha\"})-[:HAS_TASK]->(t:Task {title: \"Draft Requirements\"}) RETURN t" | ✅ | 638ms | - [📜](./09/serial.log) - |
| 10 | Then the response status should be 200 | ✅ | 0ms | - - - |
| 11 | And the GQL result should have at least 1 rows | ❌ | 1013ms | - [📜](./11/serial.log) - |
