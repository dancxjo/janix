...
| 2 | Then I should see a message in the serial output that says "thing-os kernel starting" within 60s | ✅ | 8116ms | - [📜](./02/serial.log) - |
| 3 | And I should see log messages on the terminal | ✅ | 505ms | - [📜](./03/serial.log) - |
| 4 | And each log message should include a monotonically increasing timestamp | ✅ | 0ms | - - - |
| 5 | And I should see the system clock tick for several seconds in the serial console | ✅ | 3004ms | - [📜](./05/serial.log) - |
