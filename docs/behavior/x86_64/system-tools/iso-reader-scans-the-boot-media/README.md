...
| 2 | When I wait for the system to reach ready state | ✅ | 5063ms | - - - |
| 3 | Then the serial output should contain "ISO_READER: Starting ISO9660 reader service" | ❌ | 121015ms | - [📜](./03/serial.log) - |
