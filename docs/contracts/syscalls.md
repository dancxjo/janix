...
| 2 | `SYSCALL_SLEEP_UNTIL` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 3 | `SYSCALL_TIME_MONOTONIC_NS` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 4 | `SYSCALL_TIME_SYSTEM_NS` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 5 | `SYSCALL_TIME_NOW` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
...
| 8 | `SYSCALL_ALLOC_FRAME` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 9 | `SYSCALL_FREE_FRAME` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 10 | `SYSCALL_CREATE_PROCESS` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 11 | `SYSCALL_CREATE_THREAD` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
...
| 14 | `SYSCALL_THING_GET` | `N/A` | `kernel::symbols::resolve` | unsafe block, direct user memory |
...
| 32 | `SYSCALL_THING_BATCH_UPDATE` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
| 33 | `SYSCALL_SCHEMA_GET` | `N/A` | `Not found in x86_64/syscall.rs` | Missing handler |
