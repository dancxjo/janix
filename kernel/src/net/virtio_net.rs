...
impl VirtioNetDevice {
    ...
    pub fn new(pci_dev: VirtioPciDevice, hhdm_offset: u64) -> Result<Self, &'static str> {
        ...
        let rx_queue_phys =
            crate::memory::alloc_contiguous_frames((rx_queue_mem_size + 4095) / 4096)
        ...
        let tx_queue_phys =
            crate::memory::alloc_contiguous_frames((tx_queue_mem_size + 4095) / 4096)
        ...
        for _ in 0..NUM_RX_BUFFERS {
            let phys = crate::memory::alloc_contiguous_frames((RX_BUFFER_SIZE + 4095) / 4096)
        ...
        let tx_buffer_phys = crate::memory::alloc_contiguous_frames((TX_BUFFER_SIZE + 4095) / 4096)
