...
impl Virtqueue {
    ...
    pub fn new(queue_size: u16, phys_addr: u64, virt_addr: u64) -> Self {
        ...
        let descriptors = unsafe {
            core::slice::from_raw_parts_mut(desc_virt as *mut VirtqueueDescriptor, queue_size as usize)
        };
    ...
    fn alloc_desc(&mut self) -> Option<u16> {
        ...
        let descriptors = unsafe {
            core::slice::from_raw_parts_mut(self.desc_virt as *mut VirtqueueDescriptor, self.queue_size as usize)
        };
