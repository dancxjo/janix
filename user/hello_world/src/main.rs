...
pub extern "C" fn main() -> ! {
    ...
    unsafe {
        ...
        if r12_out != 0x1212_1212_1212_1212 {
            log_str("R12 corrupted\n");
            loop {}
        }
        if r13_out != 0x1313_1313_1313_1313 {
            log_str("R13 corrupted\n");
            loop {}
        }
        if r14_out != 0x1414_1414_1414_1414 {
            log_str("R14 corrupted\n");
            loop {}
        }
        if r15_out != 0x1515_1515_1515_1515 {
            log_str("R15 corrupted\n");
            loop {}
        }
