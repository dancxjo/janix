...
use crate::tessellate::{TessellatedPath, TessellateConfig};
use crate::vir::{VirPoint, StrokeStyle, LineCap, LineJoin};
use alloc::vec::Vec;
    ...
    for contour in &path.contours {
        ...
        for i in 0..points.len() {
            ...
            let (left, right) = if i == 0 {
                ...
                // Middle point - join
                offset_point_join(prev, curr, next, half_width, stroke.line_join, stroke.miter_limit)
            };
...
mod tests {
    ...
    fn test_stroke_expansion() {
        ...
        path.contours.push(crate::tessellate::Contour {
            start: 0,
            count: 2,
        });
