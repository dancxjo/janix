...
pub fn example_filled_rect(x: f32, y: f32, width: f32, height: f32, r: u8, g: u8, b: u8) -> VirDocument {
...
pub fn example_stroked_line(x1: f32, y1: f32, x2: f32, y2: f32, width: f32, r: u8, g: u8, b: u8) -> VirDocument {
    let mut doc = VirDocument::new();
