...
use crate::tessellate::{TessellatedPath, TessellateConfig, tessellate_fill, tessellate_stroke};
use crate::vir::{VirDocument, VirElement, VirColor, FillRule, Paint, VirTransform};
use alloc::vec::Vec;
...
mod tests {
    use super::*;
    use crate::vir::{VirPath, FillStyle, VirColor, FillRule};
    use alloc::sync::Arc;
