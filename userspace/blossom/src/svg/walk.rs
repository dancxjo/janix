...
use abi::schema::{rels, keys as props};
use stem::thing::sys;
use abi::types::Edge;
...
pub trait SvgGraph {
    ...
    fn get_attributes(&self, elem: ThingId) -> alloc::vec::Vec<(alloc::string::String, alloc::string::String)>;
}
...
impl SvgGraph for SysSvgGraph {
    ...
    fn get_attributes(&self, _elem: ThingId) -> alloc::vec::Vec<(alloc::string::String, alloc::string::String)> {
        alloc::vec::Vec::new() // TODO
    }
}
